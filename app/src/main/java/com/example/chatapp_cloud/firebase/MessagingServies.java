package com.example.chatapp_cloud.firebase;
...
public class MessagingServies extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        student.id = remoteMessage.getData().get( Constants.KEY_USER_ID);
        student.Firstname = remoteMessage.getData().get( Constants.KEY_FIRST_NAME );
        ...
        builder.setContentTitle( student.Firstname );
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){
            CharSequence chanalName = "Chat Message";
            String channelDescription = "This notification channel is used for chat message notification ";
            int importance = NotificationManager.IMPORTANCE_DEFAULT;
            NotificationChannel channel = new NotificationChannel( channelId ,chanalName ,importance );
